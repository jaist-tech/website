  ...
  top: {
    ...
    activities: {
      ...
      sakuraHackathon: {
        ...
        date: "6月中旬",
        description:
          "春に開催されるチーム開発形式のハッカソンです。新メンバーも参加しやすく、仲間を増やしながら開発経験を積める、交流と挑戦のきっかけになるイベントです。",
      },
      jaistFestival: {
        iconEmoji: "🎟️",
        title: "JAISTフェスティバル",
      ...
      snowHackathon: {
        ...
        date: "2月初旬",
        description:
          "冬に開催されるチーム開発形式のハッカソンです。約一年間の活動で身につけた知識や技術を活かして開発に取り組み、自分たちの成長を実感できるイベントです。",
      },
      lt: {
        iconEmoji: "⚡",
        title: "LT会",
        date: "不定期",
        description:
          "メンバーの希望に応じて開催される、短時間のプレゼンイベントです。技術的な話題から趣味の話まで自由なテーマで発表でき、気軽に交流も楽しめます。",
      },
