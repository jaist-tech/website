  ...
  top: {
    ...
    activities: {
      ...
      sakuraHackathon: {
        ...
        date: "6月中旬",
        description:
          "春に開催されるチーム開発形式の学内ハッカソンです。新メンバーも参加しやすく、仲間を増やしながら開発経験を積める、交流と挑戦のきっかけになるイベントです。",
      },
      jaistFestival: {
        iconEmoji: "🎟️",
        title: "JAISTフェスティバル",
        date: "10月下旬",
        description:
          "JAISTで行われる学園祭にサークルで制作した作品やアプリケーションを展示します。日頃の活動成果を学内外の来場者に向けて発信できる貴重な機会です。",
      },
      snowHackathon: {
        iconEmoji: "❄️",
        title: "雪華ハッカソン",
        date: "2月初旬",
        description:
          "冬に開催されるチーム開発形式の学内ハッカソンです。約一年間の活動で身につけた知識や技術を活かして開発に取り組み、自分たちの成長を実感できるイベントです。",
      },
      studyMeeting: {
        iconEmoji: "📚",
        title: "LT・勉強会",
        date: "不定期",
        description:
          "メンバーの希望に応じて開催される、発表や勉強を気軽に楽しめるイベントです。技術的な話題から趣味の話まで幅広いテーマを扱い、交流の場にもなっています。",
      },
      others: "そのほかにも他大学との交流会なども行われています！",
    },
    news: "News",
    link: "Official Link",
  },
